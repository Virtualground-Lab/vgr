...
const VGRCrowdsale = artifacts.require("./VGRCrowdsale.sol");
const VGRContinuousSale = artifacts.require("./VGRContinuousSale.sol");
...
contract(
  "VGRCrowdsale",
  function ([_, wallet, wallet2, buyer, purchaser, buyer2, purchaser2]) {
    ...
    beforeEach(async function () {
      ...
      crowdsale = await VGRCrowdsale.new(
        startBlock,
        endBlock,
        initialRate,
        endRate,
      ...
      token = VGRToken.at(await crowdsale.token());
    });
    ...
    it("owner should be able to change wallet", async function () {
      ...
      const continuousSale = VGRContinuousSale.at(
    ...
    it("owner should be able to start continuous sale", async function () {
      ...
      const sale = VGRContinuousSale.at(await crowdsale.continuousSale());
